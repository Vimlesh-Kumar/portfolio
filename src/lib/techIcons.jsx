 ...
 *
 * Each entry is a render function `(size: number) => JSX.Element` so the icon
 * can be sized on demand. Keys are lowercase and several aliases map to the same
 * glyph (e.g. `"vue"`, `"vue 3"`, `"vue.js"`). See {@link brandColors} for the
 * matching accent colors.
 *
 * @type {Record<string, (size: number) => JSX.Element>}
 */
export const icons = {
  vue: (size) => (
